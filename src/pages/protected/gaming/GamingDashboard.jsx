  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card title="Total Games Registrations" value={stats.totalGamingRegistrations} />
        <Card title="Total Counsiling Registrations" value={stats.totalCounsilingRegistrations} />
